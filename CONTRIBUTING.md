...
# AI Usage Policy (this fork)

> [!NOTE]
> **This fork's policy differs from upstream llama.cpp's.** Skylark Software
> develops with AI openly: disclosed, human-reviewed AI contributions are
> welcome here and are attributed honestly in the commit history. The bar is
> accountability, not provenance — whoever submits a change must be able to
> explain and defend it. See [AGENTS.md](AGENTS.md).
>
> **Upstream llama.cpp does not accept predominantly AI-generated PRs.** If
> you are preparing a change intended for upstream, follow
> [their policy](https://github.com/ggml-org/llama.cpp/blob/master/CONTRIBUTING.md)
> for that submission.
